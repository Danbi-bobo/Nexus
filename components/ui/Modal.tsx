...
export const Modal: React.FC<ModalProps> = ({ isOpen, onClose, title, children, footer }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center" aria-labelledby="modal-title" role="dialog" aria-modal="true">
      ...
      <div className="relative w-full max-w-lg transform rounded-lg bg-gray-800 border border-gray-700 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-2xl">
        ...
        {footer && (
          <div className="flex items-center p-6 space-x-2 border-t border-gray-700 rounded-b">
            {footer}
          </div>
        )}
      </div>
